                ...
                <div class="box-left-home ">
                    <div style="margin-top: 30px; ">
                        <ul class="breadcrumb ">
                            ...
                            <li class="breadcrumb-item ">
                                <a href="register.php">Đăng ký </a></li>
                        </ul>
                    </div>
...
<?php
    require_once('../db/logic_register.php');
...
?>
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control login_input" name="id">
                </div>
                <div class="form-group">
                    <label>Họ và tên</label>
                    <input type="text" class="form-control login_input" name="name">
                </div>
                <div class="form-group">
                    <label>Tuổi </label>
                    <input type="number" class="form-control login_input" name="tuoi">
                </div>
                <div class="form-group">
                    <label>Quê quán</label>
                    <input type="text" class="form-control login_input" name="que">
                </div>
                <div class="form-group">
                    <label>Email</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control login_input" name="phuongtien">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary w-100 " style="margin-left : 120px" >Login</button>
            </form>
        </div>
    </div>
